<script>
	...
	import Header from 'components/signup/header.svelte';
	import Progress from 'components/signup/progress.svelte';
...
<div
	class="w-screen h-screen bg-[#333] flex flex-col justify-end overflow-y-hidden"
